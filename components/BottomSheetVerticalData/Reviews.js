    ...
    return (
        <View>
            <View style={styles.row}>
                <Text style={[styles.headerTitleText, { fontSize: 24 }]}>Reviews & Ratings</Text>
                <View>
                    <Text style={[styles.headerTitleText, { fontSize: 24, color: 'green' }]}><AntDesign name='star' size={24} color='green' /> {ratingsData.average}</Text>
            ...
            <FlatList
                style={[styles.row, { justifyContent: 'none', flexWrap: 'wrap', marginTop: 25, minHeight: 20 }]}
                data={reviewData}
            ...
            <PrimaryButton style={{ opacity: .7, height: 40, marginTop: 35 }} title='Read All Reviews (381)' />
        </View>
    )
}
