    ...
    <View>
      ...
      <View style={[styles.row, { padding: 20, justifyContent: "none" }]}>
        <View style={{ marginRight: 20 }}>
          ...
          <Text style={{ opacity: 0.6, marginBottom: 20 }}>6 May</Text>

          <Text style={[styles.stdTextBottomSheet, { fontWeight: "bold" }]}>
            20:40
          </Text>
          <Text style={{ opacity: 0.6 }}>6 May</Text>
        </View>
        ...
        <View>
          ...
          <Text
            style={{ width: 180, fontSize: 12, opacity: 0.6, marginBottom: 8 }}
          >
            Parking No. 1 Near Kashmiri Gate Metro Gate No. 1, Delhi
          </Text>
          <Text style={[styles.stdTextBottomSheet, { fontWeight: "bold" }]}>
            Gautam Buddha Gate Chilla Border
          </Text>
          <Text style={{ width: 180, fontSize: 12, opacity: 0.6 }}>
            Gautam Buddha Gate, Chilla
          </Text>
        </View>
      </View>
    </View>
