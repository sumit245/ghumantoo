...
const Ratings = ({ star, percent }) => {
    return (
        <View style={styles.row}>
            <Text style={{ fontSize: 16, fontWeight: 600, color: '#17171f' }}>{star} <AntDesign name='star' size={15} /></Text>
            ...
            <Text style={{ fontSize: 16, fontWeight: 500, color: '#17171f' }}>{percent}%</Text>
        </View>
    )
}
