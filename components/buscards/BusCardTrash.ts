  ...
  return (
    <TouchableOpacity onPress={onClick} style={styles.card}>
      <View style={styles.vehicleInfo}>
        <Text style={styles.vehicleNumber}>{bus.TravelName}</Text>
        <Text style={styles.busStand}>{bus.BusType || ""}</Text>
      </View>

      <View style={styles.row}>
        <View style={styles.timing}>
          <Text style={styles.departureTime}>{dayjs(bus.DepartureTime).format("h:mmA")}</Text>
          <Text style={styles.separator}>—</Text>
          <Text style={styles.arrivalTime}>{dayjs(bus.ArrivalTime).format("h:mmA")}</Text>
        </View>
      </View>
      ...
      <View style={styles.row}>
        <View style={styles.timing}>
          ...
          <Text style={styles.separator}>—</Text>
          <Text style={styles.time}>{bus.AvailableSeats || 0} seats</Text>
        </View>
      </View>
